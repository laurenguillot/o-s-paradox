...
econ2016 <- econ2016 %>%
  ...
  mutate(age75 = ifelse(V161267x == 6, 1, 0 #age group 75 or older
                           )) %>%
...
econ2016 <- econ2016 %>%
  select("caseid", "weight", "stfips", "stabbrev", "congdist", "libcon", "partyid", "educ", "race", "hispanic", "white", "white1", "black", "asian", "natamer", "otherrace", "gender", "fecon2016", "age18_24", "age25_34", "age35_44", "age45_54", "age55_64", "age65_74", "age75", "lessdiploma", "somecoll", "associate", "bachelors", "grad")
```
